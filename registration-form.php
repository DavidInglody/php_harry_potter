    ...
    <main>
        <section class="registration-form">
            ...
            <form action="./admin/after-registration.php" method="POST">
                ...
                <input class="reg-input" type="email" name = "email" placeholder= "E-mail"> <br> 
                <input class="reg-input password-first" type="password" name = "password" placeholder = "Heslo"> <br>
                <input class="reg-input password-second" type="password" name = "password-again" placeholder = "Opakovať heslo"> <br>
                <p class="result-text"></p>
                <input class="btn" type="submit" value = "Registrovať">
            </form>
        </section>
    </main>
